...
const ChatPanel = (function() {
    ...
    const showUserTyping = function(user) {
        $("#user-typing").text(user + ' is typing...');
    };

    const hideUserTyping = function() {
		$("#user-typing").text(" ");
    };
    ...
    const initialize = function() {
        ...
        $("#chat-input-form").on("click", function(e) {
            $(document).on("keydown", function(event) {
                Socket.getUserTyping(event);
            });

            $(document).on("keyup", function(event) {
                Socket.hideUserTyping(event);
            });
        });
 	};
    ...
    return { initialize, update, addMessage, showUserTyping, hideUserTyping };
})();
